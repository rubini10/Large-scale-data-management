...
account_url = "abfss://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"

#create a client to interact with blob storage
connect_str = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
...
df_finale = df_finale.filter("Passenger_count != 0")
df_finale.createOrReplaceTempView("data")
...
df.write.parquet("abfss://dati@clustersparkstoragea.dfs.core.windows.net/output/output_numeroPasseggeri_3W.parquet")
